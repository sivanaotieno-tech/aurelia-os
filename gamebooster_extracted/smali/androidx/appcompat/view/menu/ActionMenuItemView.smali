...
# instance fields
.field e:Landroidx/appcompat/view/menu/o;

.field private f:Ljava/lang/CharSequence;

.field private g:Landroid/graphics/drawable/Drawable;

.field h:Landroidx/appcompat/view/menu/k$b;

.field private i:Landroidx/appcompat/widget/T;
...
.method private f()V
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Landroidx/appcompat/view/menu/o;
    ...
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/o;->getContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/o;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/o;->getTooltipText()Ljava/lang/CharSequence;
    ...
    .line 11
    :cond_5
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Landroidx/appcompat/view/menu/o;

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/o;->getTitle()Ljava/lang/CharSequence;

    move-result-object v1

    :goto_4
    invoke-static {p0, v1}, Landroidx/appcompat/widget/Fa;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    goto :goto_5

    .line 12
    :cond_6
    invoke-static {p0, v2}, Landroidx/appcompat/widget/Fa;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
# virtual methods
.method public a(Landroidx/appcompat/view/menu/o;I)V
    .locals 0

    .line 1
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Landroidx/appcompat/view/menu/o;

    .line 2
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/o;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    invoke-virtual {p1, p0}, Landroidx/appcompat/view/menu/o;->a(Landroidx/appcompat/view/menu/u$a;)Ljava/lang/CharSequence;
    ...
    .line 4
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/o;->getItemId()I
    ...
    .line 5
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/o;->isVisible()Z
    ...
    .line 8
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->i:Landroidx/appcompat/widget/T;
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->i:Landroidx/appcompat/widget/T;
...
.method public c()Z
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/o;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public d()Z
    ...
    .line 1
    invoke-virtual {p0}, Landroidx/appcompat/widget/K;->getText()Ljava/lang/CharSequence;
...
.method public getItemData()Landroidx/appcompat/view/menu/o;
    .locals 1
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 1
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Landroidx/appcompat/view/menu/k$b;
    ...
    invoke-interface {p1, v0}, Landroidx/appcompat/view/menu/k$b;->a(Landroidx/appcompat/view/menu/o;)Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/o;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->i:Landroidx/appcompat/widget/T;
...
.method public setExpandedFormat(Z)V
    ...
    .line 3
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Landroidx/appcompat/view/menu/o;

    if-eqz p1, :cond_0

    .line 4
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/o;->b()V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 7
    invoke-virtual {p0, p1, v0, v0, v0}, Landroidx/appcompat/widget/K;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method public setItemInvoker(Landroidx/appcompat/view/menu/k$b;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Landroidx/appcompat/view/menu/k$b;
