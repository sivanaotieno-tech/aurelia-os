...
.field private static final b:Lb/h/f/k;

.field static final c:Ljava/lang/Object;

.field static final d:Lb/e/i;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lb/e/i<",
            "Ljava/lang/String;",
...
.method public static a(Landroid/content/pm/PackageManager;Lb/h/f/a;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    .locals 5

    .line 43
    invoke-virtual {p1}, Lb/h/f/a;->d()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lb/h/f/a;->e()Ljava/lang/String;
    ...
    invoke-static {p0}, Lb/h/f/f;->a([Landroid/content/pm/Signature;)Ljava/util/List;

    move-result-object p0

    .line 48
    sget-object v0, Lb/h/f/f;->e:Ljava/util/Comparator;

    invoke-static {p0, v0}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    .line 49
    invoke-static {p1, p2}, Lb/h/f/f;->a(Lb/h/f/a;Landroid/content/res/Resources;)Ljava/util/List;
    ...
    .line 53
    invoke-static {p0, p2}, Lb/h/f/f;->a(Ljava/util/List;Ljava/util/List;)Z
...
.method public static a(Landroid/content/Context;Lb/h/f/a;Lb/h/a/a/h$a;Landroid/os/Handler;ZII)Landroid/graphics/Typeface;
    .locals 2
    ...
    invoke-virtual {p1}, Lb/h/f/a;->c()Ljava/lang/String;
    ...
    .line 11
    invoke-virtual {p2, v1}, Lb/h/a/a/h$a;->a(Landroid/graphics/Typeface;)V
    ...
    invoke-virtual {p2, p1, p3}, Lb/h/a/a/h$a;->a(Landroid/graphics/Typeface;Landroid/os/Handler;)V

    goto :goto_0

    .line 15
    :cond_2
    invoke-virtual {p2, p1, p3}, Lb/h/a/a/h$a;->a(ILandroid/os/Handler;)V
    ...
    invoke-direct {p1, p2, p3}, Lb/h/f/c;-><init>(Lb/h/a/a/h$a;Landroid/os/Handler;)V
...
.method public static a(Landroid/content/Context;Landroid/os/CancellationSignal;Lb/h/f/a;)Lb/h/f/f$a;
    ...
    .line 39
    invoke-static {v0, p2, v1}, Lb/h/f/f;->a(Landroid/content/pm/PackageManager;Lb/h/f/a;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    .line 40
    new-instance p0, Lb/h/f/f$a;

    const/4 p1, 0x1

    const/4 p2, 0x0

    invoke-direct {p0, p1, p2}, Lb/h/f/f$a;-><init>(I[Lb/h/f/f$b;)V
    ...
    invoke-static {p0, p2, v0, p1}, Lb/h/f/f;->a(Landroid/content/Context;Lb/h/f/a;Ljava/lang/String;Landroid/os/CancellationSignal;)[Lb/h/f/f$b;

    move-result-object p0

    .line 42
    new-instance p1, Lb/h/f/f$a;

    const/4 p2, 0x0

    invoke-direct {p1, p2, p0}, Lb/h/f/f$a;-><init>(I[Lb/h/f/f$b;)V

    return-object p1
.end method

.method static a(Landroid/content/Context;Lb/h/f/a;I)Lb/h/f/f$c;
    .locals 3
    ...
    .line 2
    invoke-virtual {p1}, Lb/h/f/f$a;->b()I
    ...
    .line 3
    invoke-virtual {p1}, Lb/h/f/f$a;->a()[Lb/h/f/f$b;

    move-result-object p1

    .line 4
    invoke-static {p0, v0, p1, p2}, Lb/h/b/c;->a(Landroid/content/Context;Landroid/os/CancellationSignal;[Lb/h/f/f$b;I)Landroid/graphics/Typeface;
...
.method private static a(Lb/h/f/a;Landroid/content/res/Resources;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 57
    invoke-virtual {p0}, Lb/h/f/a;->a()Ljava/util/List;
    ...
    .line 59
    :cond_0
    invoke-virtual {p0}, Lb/h/f/a;->b()I

    move-result p0

    .line 60
    invoke-static {p1, p0}, Lb/h/a/a/c;->a(Landroid/content/res/Resources;I)Ljava/util/List;
...
.method public static a(Landroid/content/Context;[Lb/h/f/f$b;Landroid/os/CancellationSignal;)Ljava/util/Map;
    ...
    .line 32
    invoke-virtual {v3}, Lb/h/f/f$b;->a()I
    ...
    .line 33
    :cond_0
    invoke-virtual {v3}, Lb/h/f/f$b;->c()Landroid/net/Uri;
    ...
    .line 35
    :cond_1
    invoke-static {p0, p2, v3}, Lb/h/b/k;->a(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
...
.method static a(Landroid/content/Context;Lb/h/f/a;Ljava/lang/String;Landroid/os/CancellationSignal;)[Lb/h/f/f$b;
    .locals 20
    ...
    .line 77
    invoke-virtual/range {p1 .. p1}, Lb/h/f/a;->f()Ljava/lang/String;
