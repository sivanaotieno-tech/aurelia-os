...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/common/j;->zzbt:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/j;->zzbu:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static cancelAvailabilityErrorNotifications(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/google/android/gms/common/j;->zzbt:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static enableUsingApkIndependentContext()V
    ...
    sget-object v0, Lcom/google/android/gms/common/j;->zzbu:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static ensurePlayServicesAvailable(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0}, Lcom/google/android/gms/common/j;->ensurePlayServicesAvailable(Landroid/content/Context;I)V
...
.method public static honorsDebugCertificates(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/j;->isTestKeysBuild(Landroid/content/Context;)Z

    move-result p0

    if-nez p0, :cond_1

    invoke-static {}, Lcom/google/android/gms/common/j;->isUserBuildDevice()Z
...
.method public static isGooglePlayServicesAvailable(Landroid/content/Context;I)I
    ...
    :goto_2
    invoke-static {p0, v0, p1}, Lcom/google/android/gms/common/j;->zza(Landroid/content/Context;ZI)I
...
.method public static isPlayServicesPossiblyUpdating(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lcom/google/android/gms/common/j;->isUninstalledAppPossiblyUpdating(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static isTestKeysBuild(Landroid/content/Context;)Z
    ...
    sget-boolean v0, Lcom/google/android/gms/common/j;->zzbs:Z
    ...
    invoke-virtual {p0, v1, v2}, Lcom/google/android/gms/common/k;->a(Landroid/content/pm/PackageInfo;Z)Z

    move-result v3

    if-nez v3, :cond_0

    invoke-virtual {p0, v1, v0}, Lcom/google/android/gms/common/k;->a(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v0, Lcom/google/android/gms/common/j;->zzbr:Z

    goto :goto_0

    :cond_0
    sput-boolean v2, Lcom/google/android/gms/common/j;->zzbr:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_0
    sput-boolean v0, Lcom/google/android/gms/common/j;->zzbs:Z
    ...
    :cond_1
    :goto_2
    sget-boolean p0, Lcom/google/android/gms/common/j;->zzbr:Z
...
.method private static zza(Landroid/content/Context;ZI)I
    ...
    invoke-virtual {p0, v5, v0}, Lcom/google/android/gms/common/k;->a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-virtual {p0, v3, v0}, Lcom/google/android/gms/common/k;->a(Landroid/content/pm/PackageInfo;Z)Z
