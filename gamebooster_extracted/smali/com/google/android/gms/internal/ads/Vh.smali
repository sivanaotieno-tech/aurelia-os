...
.method public constructor <init>(Lcom/google/android/gms/internal/ads/wh;Z)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/android/gms/internal/ads/xh;-><init>(Lcom/google/android/gms/internal/ads/wh;Z)V
...
.method protected final a(Landroid/webkit/WebView;Ljava/lang/String;Ljava/util/Map;)Landroid/webkit/WebResourceResponse;
    ...
    invoke-interface {v0, p2, p3, v1}, Lcom/google/android/gms/internal/ads/qd;->a(Ljava/lang/String;Ljava/util/Map;I)V
    ...
    :cond_2
    invoke-super {p0, p2, p3}, Lcom/google/android/gms/internal/ads/xh;->a(Ljava/lang/String;Ljava/util/Map;)Landroid/webkit/WebResourceResponse;
    ...
    invoke-interface {p2}, Lcom/google/android/gms/internal/ads/di;->b()V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/internal/ads/ji;->d()Z

    move-result p2

    if-eqz p2, :cond_5

    sget-object p2, Lcom/google/android/gms/internal/ads/Yu;->ea:Lcom/google/android/gms/internal/ads/Ou;
    ...
    :cond_5
    invoke-interface {p1}, Lcom/google/android/gms/internal/ads/wh;->K()Z

    move-result p2

    if-eqz p2, :cond_6

    sget-object p2, Lcom/google/android/gms/internal/ads/Yu;->da:Lcom/google/android/gms/internal/ads/Ou;

    goto :goto_0

    :cond_6
    sget-object p2, Lcom/google/android/gms/internal/ads/Yu;->ca:Lcom/google/android/gms/internal/ads/Ou;
    ...
    invoke-static {p3, p1, p2}, Lcom/google/android/gms/internal/ads/ie;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/webkit/WebResourceResponse;
