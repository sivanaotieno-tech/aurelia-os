.class final Lcom/moat/analytics/mobile/ogury/t;
.super Lcom/moat/analytics/mobile/ogury/c;
.source "SourceFile"

# interfaces
.implements Lcom/moat/analytics/mobile/ogury/NativeDisplayTracker;
...
.method constructor <init>(Landroid/view/View;Ljava/util/Map;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0, v1}, Lcom/moat/analytics/mobile/ogury/c;-><init>(Landroid/view/View;ZZ)V
    ...
    iput-object v0, p0, Lcom/moat/analytics/mobile/ogury/t;->ॱॱ:Ljava/util/Set;
    ...
    .line 4
    iput-object p2, p0, Lcom/moat/analytics/mobile/ogury/t;->ʼ:Ljava/util/Map;

    if-nez p1, :cond_0

    const-string p1, "Target view is null"

    const-string p2, "NativeDisplayTracker initialization not successful, "
    ...
    .line 6
    invoke-static {v2, v1, p0, p2}, Lcom/moat/analytics/mobile/ogury/e$1;->ˋ(ILjava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V

    .line 7
    invoke-static {v0, p2}, Lcom/moat/analytics/mobile/ogury/e$1;->ॱ(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/moat/analytics/mobile/ogury/c;->ˎ:Lcom/moat/analytics/mobile/ogury/l;
    ...
    iget-object p1, p1, Lcom/moat/analytics/mobile/ogury/i;->ˊ:Lcom/moat/analytics/mobile/ogury/d;
    ...
    .line 15
    :cond_2
    iget-object v0, p1, Lcom/moat/analytics/mobile/ogury/d;->ˋ:Lcom/moat/analytics/mobile/ogury/f;

    .line 16
    iput-object v0, p0, Lcom/moat/analytics/mobile/ogury/c;->ˋ:Lcom/moat/analytics/mobile/ogury/f;
    ...
    invoke-direct {p0}, Lcom/moat/analytics/mobile/ogury/t;->ᐝ()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p1, v0}, Lcom/moat/analytics/mobile/ogury/f;->ॱ(Ljava/lang/String;)V
    ...
    .line 27
    invoke-static {v2, v0, p0, p1}, Lcom/moat/analytics/mobile/ogury/e$1;->ˋ(ILjava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
...
.method private ʼ()Ljava/lang/String;
    ...
    .line 1
    :try_start_0
    invoke-super {p0}, Lcom/moat/analytics/mobile/ogury/c;->ॱॱ()Landroid/view/View;

    move-result-object v0

    invoke-static {v0}, Lcom/moat/analytics/mobile/ogury/v;->ॱ(Landroid/view/View;)Landroid/graphics/Rect;
...
.method private ᐝ()Ljava/lang/String;
    ...
    .line 1
    :try_start_0
    iget-object v1, p0, Lcom/moat/analytics/mobile/ogury/t;->ʼ:Ljava/util/Map;
    ...
    invoke-static {v2, v3, p0, v4}, Lcom/moat/analytics/mobile/ogury/e$1;->ˋ(ILjava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct {p0}, Lcom/moat/analytics/mobile/ogury/t;->ʼ()Ljava/lang/String;
...
# virtual methods
.method public final reportUserInteractionEvent(Lcom/moat/analytics/mobile/ogury/NativeDisplayTracker$MoatUserInteractionType;)V
    .locals 4
    ...
    .line 2
    iget-object v0, p0, Lcom/moat/analytics/mobile/ogury/t;->ॱॱ:Ljava/util/Set;
    ...
    .line 5
    iget-object v2, p0, Lcom/moat/analytics/mobile/ogury/c;->ॱ:Ljava/lang/String;
    ...
    invoke-virtual {p1, v0}, Lcom/moat/analytics/mobile/ogury/f;->ˋ(Ljava/lang/String;)V
    :try_end_0
    ...
    .line 10
    invoke-static {v0, p0, v1}, Lcom/moat/analytics/mobile/ogury/e$1;->ˎ(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
