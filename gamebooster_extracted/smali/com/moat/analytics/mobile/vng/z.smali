...
.method private static a(Landroid/view/View;Landroid/graphics/Rect;ZZZ)Lcom/moat/analytics/mobile/vng/z$a;
    ...
    invoke-static {p4, v1, v2, v3}, Lcom/moat/analytics/mobile/vng/p;->b(ILjava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    iput-object p2, v0, Lcom/moat/analytics/mobile/vng/z$a;->a:Landroid/graphics/Rect;

    invoke-static {p2, p0, p4}, Lcom/moat/analytics/mobile/vng/z;->a(Landroid/graphics/Rect;Landroid/view/View;Ljava/util/Set;)Z
    ...
    iput-wide v1, v0, Lcom/moat/analytics/mobile/vng/z$a;->c:D

    :cond_1
    if-nez p0, :cond_3

    invoke-static {p2, p4}, Lcom/moat/analytics/mobile/vng/z;->a(Landroid/graphics/Rect;Ljava/util/Set;)I
    ...
    iput-wide v3, v0, Lcom/moat/analytics/mobile/vng/z$a;->c:D
    ...
    iput-wide p2, v0, Lcom/moat/analytics/mobile/vng/z$a;->b:D
...
.method private static a(Landroid/graphics/Rect;Landroid/view/View;Ljava/util/Set;)Z
    ...
    invoke-static {v3, v0, p1, v2}, Lcom/moat/analytics/mobile/vng/p;->b(ILjava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v3, v5, p0, v6}, Lcom/moat/analytics/mobile/vng/p;->b(ILjava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    :cond_2
    invoke-static {v6}, Lcom/moat/analytics/mobile/vng/z;->g(Landroid/view/View;)Z
    ...
    invoke-static {v6}, Lcom/moat/analytics/mobile/vng/z;->h(Landroid/view/View;)Landroid/graphics/Rect;
    ...
    invoke-static {v3, v8, v6, v9}, Lcom/moat/analytics/mobile/vng/p;->b(ILjava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
...
.method a(Ljava/lang/String;Landroid/view/View;)V
    ...
    invoke-static {p2, v6, v3, v4, v5}, Lcom/moat/analytics/mobile/vng/z;->a(Landroid/view/View;Landroid/graphics/Rect;ZZZ)Lcom/moat/analytics/mobile/vng/z$a;
    ...
    iget-wide v3, p2, Lcom/moat/analytics/mobile/vng/z$a;->b:D

    iget-object v5, p0, Lcom/moat/analytics/mobile/vng/z;->b:Lcom/moat/analytics/mobile/vng/z$a;

    iget-wide v9, v5, Lcom/moat/analytics/mobile/vng/z$a;->b:D

    cmpl-double v5, v3, v9

    if-nez v5, :cond_3

    iget-object v3, p2, Lcom/moat/analytics/mobile/vng/z$a;->a:Landroid/graphics/Rect;

    iget-object v4, p0, Lcom/moat/analytics/mobile/vng/z;->b:Lcom/moat/analytics/mobile/vng/z$a;

    iget-object v4, v4, Lcom/moat/analytics/mobile/vng/z$a;->a:Landroid/graphics/Rect;
    ...
    iget-wide v3, p2, Lcom/moat/analytics/mobile/vng/z$a;->c:D

    iget-object v5, p0, Lcom/moat/analytics/mobile/vng/z;->b:Lcom/moat/analytics/mobile/vng/z$a;

    iget-wide v9, v5, Lcom/moat/analytics/mobile/vng/z$a;->c:D
    ...
    :cond_3
    iput-object p2, p0, Lcom/moat/analytics/mobile/vng/z;->b:Lcom/moat/analytics/mobile/vng/z$a;
    ...
    iget-wide v4, p2, Lcom/moat/analytics/mobile/vng/z$a;->c:D
    ...
    :cond_8
    iget-object p1, p0, Lcom/moat/analytics/mobile/vng/z;->i:Ljava/util/Map;
    ...
    invoke-virtual {p1}, Lcom/moat/analytics/mobile/vng/o;->b()Landroid/location/Location;

    move-result-object p1

    iget-object p2, p0, Lcom/moat/analytics/mobile/vng/z;->h:Landroid/location/Location;

    invoke-static {p1, p2}, Lcom/moat/analytics/mobile/vng/o;->a(Landroid/location/Location;Landroid/location/Location;)Z

    move-result p2

    if-nez p2, :cond_b

    iput-object p1, p0, Lcom/moat/analytics/mobile/vng/z;->h:Landroid/location/Location;
    ...
    iget-object v0, p0, Lcom/moat/analytics/mobile/vng/z;->i:Ljava/util/Map;

    invoke-direct {p2, v0}, Lorg/json/JSONObject;-><init>(Ljava/util/Map;)V

    const-string v0, "screen"

    iget-object v2, p0, Lcom/moat/analytics/mobile/vng/z;->g:Lorg/json/JSONObject;
    ...
    iget-object v2, p0, Lcom/moat/analytics/mobile/vng/z;->c:Lorg/json/JSONObject;
    ...
    iget-object v2, p0, Lcom/moat/analytics/mobile/vng/z;->b:Lcom/moat/analytics/mobile/vng/z$a;

    iget-wide v2, v2, Lcom/moat/analytics/mobile/vng/z$a;->b:D
    ...
    invoke-static {p1}, Lcom/moat/analytics/mobile/vng/z;->a(Landroid/location/Location;)Lorg/json/JSONObject;
