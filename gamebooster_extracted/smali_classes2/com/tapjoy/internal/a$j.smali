.class final Lcom/tapjoy/internal/a$j;
...
.method public final a(Lcom/tapjoy/internal/a$d;)Landroid/app/Notification;
    ...
    .line 1
    iget-object v1, v0, Lcom/tapjoy/internal/a$d;->a:Landroid/content/Context;

    iget-object v2, v0, Lcom/tapjoy/internal/a$d;->r:Landroid/app/Notification;

    iget-object v3, v0, Lcom/tapjoy/internal/a$d;->b:Ljava/lang/CharSequence;

    iget-object v4, v0, Lcom/tapjoy/internal/a$d;->c:Ljava/lang/CharSequence;

    iget-object v5, v0, Lcom/tapjoy/internal/a$d;->h:Ljava/lang/CharSequence;

    iget-object v6, v0, Lcom/tapjoy/internal/a$d;->f:Landroid/widget/RemoteViews;

    iget v7, v0, Lcom/tapjoy/internal/a$d;->i:I

    iget-object v8, v0, Lcom/tapjoy/internal/a$d;->d:Landroid/app/PendingIntent;

    iget-object v9, v0, Lcom/tapjoy/internal/a$d;->e:Landroid/app/PendingIntent;

    iget-object v10, v0, Lcom/tapjoy/internal/a$d;->g:Landroid/graphics/Bitmap;

    iget v11, v0, Lcom/tapjoy/internal/a$d;->n:I

    iget v12, v0, Lcom/tapjoy/internal/a$d;->o:I

    iget-boolean v0, v0, Lcom/tapjoy/internal/a$d;->p:Z
    ...
    iget-wide v14, v2, Landroid/app/Notification;->when:J

    invoke-virtual {v13, v14, v15}, Landroid/app/Notification$Builder;->setWhen(J)Landroid/app/Notification$Builder;

    move-result-object v1

    iget v13, v2, Landroid/app/Notification;->icon:I

    iget v14, v2, Landroid/app/Notification;->iconLevel:I

    invoke-virtual {v1, v13, v14}, Landroid/app/Notification$Builder;->setSmallIcon(II)Landroid/app/Notification$Builder;

    move-result-object v1

    iget-object v13, v2, Landroid/app/Notification;->contentView:Landroid/widget/RemoteViews;

    invoke-virtual {v1, v13}, Landroid/app/Notification$Builder;->setContent(Landroid/widget/RemoteViews;)Landroid/app/Notification$Builder;

    move-result-object v1

    iget-object v13, v2, Landroid/app/Notification;->tickerText:Ljava/lang/CharSequence;

    invoke-virtual {v1, v13, v6}, Landroid/app/Notification$Builder;->setTicker(Ljava/lang/CharSequence;Landroid/widget/RemoteViews;)Landroid/app/Notification$Builder;

    move-result-object v1

    iget-object v6, v2, Landroid/app/Notification;->sound:Landroid/net/Uri;

    iget v13, v2, Landroid/app/Notification;->audioStreamType:I

    invoke-virtual {v1, v6, v13}, Landroid/app/Notification$Builder;->setSound(Landroid/net/Uri;I)Landroid/app/Notification$Builder;
    ...
    invoke-virtual {v1, v6, v13, v14}, Landroid/app/Notification$Builder;->setLights(III)Landroid/app/Notification$Builder;
    ...
    :cond_3
    invoke-virtual {v1, v9, v14}, Landroid/app/Notification$Builder;->setFullScreenIntent(Landroid/app/PendingIntent;Z)Landroid/app/Notification$Builder;
    ...
    invoke-virtual {v1, v11, v12, v0}, Landroid/app/Notification$Builder;->setProgress(IIZ)Landroid/app/Notification$Builder;
