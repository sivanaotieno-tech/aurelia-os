...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string v7, "iVBORw0KGgoAAAANSUhEUgAAAAEAAAAsCAIAAAArRUU2AAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJ\nbWFnZVJlYWR5ccllPAAAAEFJREFUeNpicPP0Zvr3/z/T/3//gDQQg+i//5j+gum/QBqIQXwg+x+Y\njckH6fkL0/f3NwMPHz8jKxsbAw0AQIABAGYHPKslk98oAAAAAElFTkSuQmCC"

    .line 14
    invoke-direct {p0, v7}, Lcom/tapjoy/mraid/view/Browser;->a(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    .line 16
    invoke-virtual {p1, v0, v6}, Landroid/widget/RelativeLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    const-string v5, "open_show_back"
    ...
    invoke-virtual {v9, v5}, Landroid/widget/ImageButton;->setImageBitmap(Landroid/graphics/Bitmap;)V

    .line 30
    new-instance v5, Lcom/tapjoy/mraid/view/Browser$1;

    invoke-direct {v5, p0}, Lcom/tapjoy/mraid/view/Browser$1;-><init>(Lcom/tapjoy/mraid/view/Browser;)V
    ...
    invoke-direct {v9, v6, v3}, Landroid/widget/LinearLayout$LayoutParams;-><init>(II)V
    ...
    .line 39
    invoke-virtual {v5, v12}, Landroid/widget/ImageButton;->setVisibility(I)V

    .line 40
    :cond_1
    new-instance v3, Lcom/tapjoy/mraid/view/Browser$2;

    invoke-direct {v3, p0}, Lcom/tapjoy/mraid/view/Browser$2;-><init>(Lcom/tapjoy/mraid/view/Browser;)V
    ...
    invoke-virtual {v3, v5}, Landroid/widget/ImageButton;->setImageBitmap(Landroid/graphics/Bitmap;)V
    ...
    .line 57
    new-instance v4, Lcom/tapjoy/mraid/view/Browser$4;

    invoke-direct {v4, p0}, Lcom/tapjoy/mraid/view/Browser$4;-><init>(Lcom/tapjoy/mraid/view/Browser;)V
    ...
    invoke-virtual {v3, v2}, Landroid/view/Window;->requestFeature(I)Z
    ...
    .line 64
    new-instance v1, Lcom/tapjoy/mraid/view/Browser$5;

    invoke-direct {v1, p0}, Lcom/tapjoy/mraid/view/Browser$5;-><init>(Lcom/tapjoy/mraid/view/Browser;)V
    ...
    .line 66
    new-instance p1, Lcom/tapjoy/mraid/view/Browser$6;

    invoke-direct {p1, p0}, Lcom/tapjoy/mraid/view/Browser$6;-><init>(Lcom/tapjoy/mraid/view/Browser;)V
